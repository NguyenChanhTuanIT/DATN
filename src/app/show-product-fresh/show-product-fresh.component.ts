...
@Component({
  selector: 'app-show-product-fresh',
  template: 
  `
  <div class='rows elementpadding'>
    <p class='elementname'>Fresh flower</p>
    <p class='elementpage'><a routerLink='/home'>Home </a>&raquo; Fresh flower</p>
...
export class ShowProductFreshComponent implements OnInit {
